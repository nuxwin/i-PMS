...
/**
 * Interface for widget view helpers
 *
 * @category    iPMS
 * @package     iPMS_View
 ...
 */
interface iPMS_View_Helper_Widget_Helper
{
	/**
	 * Sets widget container the helper should operate on by default
	 *
	 * @param   iPMS_Widget_Container_Abstract $container [optional] container to operate on. Default is null, which
	 * indicates that the container should be reset.
	 * @return  iPMS_View_Helper_Widget_Helper fluent interface, returns self
	 */
	public function setContainer(iPMS_Widget_Container_Abstract $container = null);

	/**
	 * Returns the widget container the helper operates on by default
	 *
	 ...
	 * {@link Zend_Translate}, or null. Default is null.
	 * @return  iPMS_View_Helper_Widget_Helper  fluent interface, returns self
	 */
	 ...
	 *
	 * @param   mixed $role [optional] role to set. Expects a string, an instance of type
	 * {@link Zend_Acl_Role_Interface}, or null. Default is null.
	 ...
	 * Renders helper
	 *
	 * @param   iPMS_Widget_Container_Abstract $container [optional] container to render. Default is null, which
	 * indicates that the helper should render the container returned by {@link getContainer()}.
